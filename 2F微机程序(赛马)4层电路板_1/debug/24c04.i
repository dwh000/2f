...
#line 10 "24c04.c" /0
 ...
 SFRPAGE = 0x0F;
  ...
  unsigned char ee_read(unsigned char *ptr_data,unsigned char addr,unsigned char cnt) reentrant
 {
  unsigned char count;
  unsigned int i = 0;
