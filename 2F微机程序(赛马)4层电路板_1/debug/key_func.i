...
#line 2 "key_func.c" /0
  ...
  unsigned char get_key(unsigned char chk_val)
 {
  unsigned char xdata key_value,i;
 for(i = 0;i < 4;i++)
 {
 key_value = (P1 & 0xf8);
 switch(chk_val)
 {
 case 0X07:
 if(key_value == 0XF8)	return key_value;
 break;
 case 0X0F:
 case 0X47:
 case 0X27:
 ...
 break;
 case 0X37:
 if(key_value == 0XD8)		return 0XF8;
 if(key_value == 0XE8)		return 0XF8;
 break;
 case 0XF0:
 case 0XB8:
 case 0XD8:
 case 0XE8:
 case 0X78:
 if(key_value != chk_val)		return 0XF8;
 break;
 default:
 return chk_val;	
 }
  ...
  T0DelayMs(120);
 if(chk_val == 0X07)	return key_value;
 else	return chk_val;
 }
 ...
 key_value =P2;
 if((key_value & 0x01) == 0)	return 0x99;		 
 if((key_value & 0X02) == 0)	return 0x98;		 
 if((key_value & 0x04) == 0)	return 0x97;		 
 if((key_value & 0x08) == 0)	return 0x94;		 
 if((key_value & 0X10) == 0)	return 0x93;		 
 if((key_value & 0x20) == 0)	return 0x91;		 
 if((key_value & 0X40) == 0)	return 0x92;		 
 if((key_value & 0X80) == 0)	return 0x95;		 
 return 0X20;
 }
